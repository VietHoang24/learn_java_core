...
public class CNhanVien {
    ...
    public int getmSoSP() { return mSoSP; }
    ...
    public static void xuatTieuDe(){ System.out.printf("%20s%20s%20s%20s%n", "Ho", "Ten", "So San Pham", "Luong"); }

    public void xuat(){ System.out.printf("%20s%20s%20d%20.2f%n", mHo, mTen, mSoSP, getLuong()); }
}
